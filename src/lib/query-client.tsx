...
export const queryKeys = {
  ...
  users: {
    all: ['users'] as const,
    list: (orgId: string, params?: Record<string, unknown>) => ['users', 'list', orgId, params] as const,
  ...
  scoreRequests: {
    ...
    list: (params?: Record<string, unknown>) => ['scoreRequests', 'list', params] as const,
  ...
  models: {
    all: ['models'] as const,
    list: (params?: Record<string, unknown>) => ['models', 'list', params] as const,
