...
import { z } from 'zod';
import { Loader2, ArrowRight, Shield, TrendingUp, Building2 } from 'lucide-react';
      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-primary relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-semibold">PaySwitch Credit Scoring</span>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/70">Enterprise-level data protection</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium">Real-Time Scoring</p>
                  <p className="text-sm text-white/70">Get credit scores in seconds</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium">Trusted by 50+ Institutions</p>
                  <p className="text-sm text-white/70">Banks, fintechs, and MFIs across Ghana</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="lg:hidden text-center">
            <div className="inline-flex items-center gap-2 mb-8">
              ...
              <span className="text-xl font-semibold">PaySwitch</span>
            </div>
          </div>
          ...
          <div className="text-center text-sm text-muted-foreground">
            <p>
              Need help?{' '}
              <a href="mailto:support@payswitch.com.gh" className="text-primary hover:underline">
                Contact support
              </a>
            </p>
          </div>
