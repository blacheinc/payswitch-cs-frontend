...
export default function ModelsPage() {
  ...
  const handleRollback = (id: string, version: string) => {
    toast.warning(
      `Rolling back to ${version}. Previous production model archived.`,
    );
  };
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "production":
        return (
          <Badge className="bg-green-500 hover:bg-green-600">Production</Badge>
        );
      case "staging":
                ...
                <TableBody>
                  {models.map((model) => (
                    <TableRow key={model.id}>
                      <TableCell className="font-medium">
                        <div className="flex flex-col gap-1">
                          ...
                          {model.isChampion && (
                            <Badge
                              variant="outline"
                              className="w-fit text-[10px] bg-yellow-50 text-yellow-700 border-yellow-200"
                            >
                      ...
                      <TableCell className="text-xs">{model.version}</TableCell>
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            {model.status !== "production" && (
                              <DropdownMenuItem
                                onClick={() =>
                                  handlePromote(model.id, model.version)
                                }
                              >
                            ...
                            {model.status === "production" && (
                              <DropdownMenuItem
                                onClick={() =>
                                  handleRollback(model.id, "v2.2.0")
                                }
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Feature distribution shifts detecting in last 24h
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <div className="flex items-start gap-3 p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                    ...
                    <div>
                      <p className="text-sm text-yellow-700">
                        Significant increase in high-income applicants detected.
                        PSI = 0.28 (&gt;0.25 threshold).
                      </p>
                    </div>
                  </div>
        ...
        <TabsContent value="comparison" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Compare performance metrics of the current production model
                against candidates.
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="p-4 border rounded-lg bg-green-50/50 border-green-100">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        <span>Gini</span>
                        <span className="font-medium">0.680</span>
                      </div>
                      <div className="flex justify-between">
                        <span>KS</span>
            ...
            <CardContent>
              <div className="flex flex-col items-center justify-center py-12 text-center text-muted-foreground">
                ...
                <p className="max-w-sm mt-2">
                  Scheduled retraining will run in 3 days. You can manually
