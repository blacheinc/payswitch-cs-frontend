      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Track system activities, manage data retention, and generate
            compliance reports
          </p>
        </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center justify-center p-8 text-muted-foreground border-2 border-dashed rounded-lg">
                ...
                <p>
                  Retention policy configuration is managed via infrastructure
                  code (Terraform)
                </p>
              </div>
            </CardContent>
