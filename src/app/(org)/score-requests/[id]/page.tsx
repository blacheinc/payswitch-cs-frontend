...
export default function ScoreRequestDetailPage() {
  ...
  const scorePercentage =
    ((scoreRequest.score.value - scoreRequest.score.minValue) /
      (scoreRequest.score.maxValue - scoreRequest.score.minValue)) *
    100;
  ...
  const handleRecordOutcome = () => {
    ...
    toast.success(
      "Outcome recorded. Data synchronized with ML training pipeline.",
    );
  };
          ...
          >
            ...
            <DialogContent>
              ...
              <DialogFooter>
                ...
                <Button onClick={handleRecordDecision}>Save Decision</Button>
              </DialogFooter>
            </DialogContent>
          </Dialog>
          ...
          <Dialog open={outcomeDialogOpen} onOpenChange={setOutcomeDialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Feedback on loan performance is critical for improving future
                  scoring accuracy.
                </DialogDescription>
              </DialogHeader>
              <div className="space-y-4 py-4">
        ...
        <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="relative w-40 h-40">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                      <span className="text-4xl font-bold">
                        {scoreRequest.score.value}
                      </span>
                      <span className="text-sm text-muted-foreground">
                        / {scoreRequest.score.maxValue}
                      </span>
                    </div>
                  </div>
                  <Badge
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-2xl font-semibold">
                        Top {100 - scoreRequest.score.percentile}%
                      </p>
                    </div>
                    <div>
                      <p className="text-sm text-muted-foreground">
                      ...
                      <p className="text-2xl font-semibold">
                        {Math.round(scoreRequest.score.confidence * 100)}%
                      </p>
                    </div>
                  </div>
                  <Separator />
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <p className="font-medium mt-1">
                        {scoreRequest.modelInfo.modelVersion}
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="font-medium mt-1">
                        {new Date(
                          scoreRequest.timestamps.validUntil,
                        ).toLocaleDateString()}
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="font-medium mt-1">
                        {scoreRequest.modelInfo.featuresUsed}
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {Object.entries(scoreRequest.scoreComponents).map(
                ([key, component]) => (
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Suggested actions for the lending decision
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold">
                  GHS{" "}
                  {scoreRequest.affordability.estimatedMonthlyPayment.toLocaleString()}
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-muted-foreground">
                ...
                <span className="font-semibold">
                  {Math.round(
                    scoreRequest.affordability.debtToIncomeCurrent * 100,
                  )}
                  %
                </span>
              </div>
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold">
                  {Math.round(
                    scoreRequest.affordability.debtToIncomeProjected * 100,
                  )}
                  %
                </span>
              </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold text-green-600">
                  GHS{" "}
                  {scoreRequest.affordability.disposableIncome.toLocaleString()}
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-muted-foreground">
                ...
                <span className="font-semibold">
                  GHS{" "}
                  {scoreRequest.affordability.maxRecommendedAmount.toLocaleString()}
                </span>
              </div>
              <Badge
                variant="outline"
            ...
            <CardContent className="space-y-3 text-sm">
              ...
              <div>
                ...
                <p className="font-medium">
                  {scoreRequest.applicant.nationalIdNumber}
                </p>
              </div>
              <div>
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              ...
              <div>
                ...
                <p className="font-medium">
                  {scoreRequest.employment.employer}
                </p>
              </div>
              <div>
                <p className="text-muted-foreground">Monthly Income</p>
                <p className="font-medium">
                  GHS {scoreRequest.employment.monthlyIncome.toLocaleString()}
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              <div>
                ...
                <p className="font-medium">
                  GHS {scoreRequest.loanRequest.amount.toLocaleString()}
                </p>
              </div>
              <div>
                <p className="text-muted-foreground">Tenure</p>
                <p className="font-medium">
                  {scoreRequest.loanRequest.tenure} months
                </p>
              </div>
              <div>
                <p className="text-muted-foreground">Purpose</p>
                <p className="font-medium">
                  {scoreRequest.loanRequest.purpose}
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              <div>
                ...
                <p className="font-medium">
                  {new Date(
                    scoreRequest.timestamps.requestedAt,
                  ).toLocaleString()}
                </p>
              </div>
              <div>
